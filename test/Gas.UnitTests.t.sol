...
contract GasTest is Test {
    ...
    function test_WhiteTransferAmountUpdate(
        address _recipient,
        address _sender,
        uint256 _amount,
        string calldata _name,
    ...
    function test_CheckForAdmin() public {
    ...
    function test_Transfer(uint256 _amount, address _recipient) public {
    ...
    function test_AddToWhitelist(address user, uint256 _tier) public {
        vm.expectRevert();
        vm.startPrank(user);
        vm.assume(user != owner);
        gas.addToWhitelist(user, _tier);
        vm.stopPrank();
    }
